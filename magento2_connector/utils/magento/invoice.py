            ...
            if magento_invoice:
                ...
                if partner_id_found:
                    ...
                    if 'shipping_amount' in invoice:
                        shipping_amount = invoice['shipping_amount']  # if =0 >> first invoice, and it has ship method, invoices after first invoice don't ship method
                    else:
                        shipping_amount = 0
                    ...
                    if 'tax_amount' in invoice and invoice['tax_amount'] > 0:
                        ...
                        invoice_line.append((0, 0, {'name': "To keep correct amount on Tax (for Accounting) and grant total",
                                                    'account_id': 1,
